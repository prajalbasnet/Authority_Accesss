    ...
    const cases = {
        np: [
            ...
            },
            {
                ...
                punishment:
                    "गोपनीयता ऐन अन्तर्गत मुद्दा चलाइनेछ — जरिवाना वा कारावास।",
            },
            {
        ...
        en: [
            ...
            },
            {
                ...
                punishment:
                    "Punishable under Privacy Act (fine or imprisonment).",
            },
            {
                ...
                punishment:
                    "Punishable under Cybercrime Act, Section 29.",
            },
        ],
    };
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-bold text-gray-800 mb-4">
                        {lang === "np" ? "नियम तथा नीति (Terms & Policy)" : "Terms & Policy"}
                    </h1>
                ...
                <div className="flex justify-center gap-4 mb-10">
                    <button
                        onClick={() => setLang("np")}
                        className={`px-5 py-2 rounded-lg font-semibold ${lang === "np"
                    ...
                    <button
                        onClick={() => setLang("en")}
                        className={`px-5 py-2 rounded-lg font-semibold ${lang === "en"
                            ? "bg-blue-600 text-white"
                            : "bg-gray-200 text-gray-700"
                            }`}
                    >
                ...
                <div className="space-y-8">
                    {cases[lang].map((c, i) => (
                        <div
                            key={i}
                            className="bg-white border-l-8 border-blue-600 shadow-md rounded-xl p-6 hover:shadow-xl transition"
                        >
                            <h2 className="text-2xl font-bold text-gray-800 mb-2">
                                {c.title}
                            </h2>
                            <p className="text-gray-700 mb-3">{c.detail}</p>
                ...
                <div className="text-center mt-12">
                    <button className="px-8 py-3 bg-blue-600 text-white rounded-lg font-semibold shadow-md hover:bg-blue-700 transition">
                        {lang === "np" ? "म सहमत छु" : "I Agree"}
                    </button>
                </div>
            </div>
        </section>
