...
const Hero: React.FC = () => {
  ...
  const [authMode, setAuthMode] = React.useState<"login" | "signup" | "admin">(
    "login"
  );
  ...
  return (
    <>
      <section
        ref={heroRef}
        className="relative min-h-screen bg-gradient-to-br from-white via-blue-50 to-red-50 flex items-center justify-center overflow-hidden"
      >
        {/* Top Navigation */}
          ...
          {currentUser ? (
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="bg-blue-900 text-white px-4 py-2 rounded-lg font-semibold border border-blue-900 hover:bg-blue-800 transition-colors flex items-center gap-2"
              >
                Admin Login
              </button>
            </div>
        ...
        >
          <div className="w-96 h-96 border-4 border-blue-900 opacity-10">
            <svg viewBox="0 0 200 150" className="w-full h-full">
              <path
                d="M20,20 L180,20 L160,70 L180,120 L20,120 Z"
                fill="none"
                stroke="currentColor"
                strokeWidth="2"
              />
              <path
                d="M20,20 L80,70 L20,120 Z"
                fill="none"
                stroke="currentColor"
                strokeWidth="2"
              />
        ...
        <div
          ref={waveRef}
          className="absolute top-1/4 right-1/4 w-32 h-32 rounded-full bg-red-600 opacity-10"
        ></div>

        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
          <h1
            ref={titleRef}
            className="text-5xl md:text-7xl font-bold mb-6 text-red-600 font-inter"
          >
            SunneAawaj
          </h1>
          ...
          >
            Raise complaints in Nepali speech. Smart routing, AI prioritization,
